...
global.channelLink = "https://whatsapp.com/channel/0029Vb6lgkxHVvTfleid3m3r";
global.ytch = "-";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb6lgkxHVvTfleid3m3r' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://wa.me/+94766960038?text=hello` 
                }, { quoted: message });
                return;
            }
        }
